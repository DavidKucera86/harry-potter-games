...
**Mezera:** *(zavřeno 2026-08-22)* Dockerfile `COPY` list dlouho kontroloval až `npm run test:docker`, tedy build kontejneru daleko za PR gate. Teď je čtvrtou hlídanou kopií v `brand-consistency.test.ts`, porovnávanou obousměrně.

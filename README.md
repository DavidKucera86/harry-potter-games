...
npm run typecheck    # TypeScript kontrola src/
...
3. Vitest spustí unit testy (utility, dataProvider, BaseGame, HangmanGame, QuizGame, i18n)
...
1. **Pre-deploy** — `verify:build`, `typecheck`, celá testovací sada proti localhost

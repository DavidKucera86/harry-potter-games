...
class GuessHouseGame extends QuizGame {
  ...
  constructor() {
    ...
    super({
      ...
      getCorrectMessage: (character) => strings.quiz.houseCorrect(character.name, character.house),
      getWrongMessage: (character) => strings.quiz.houseWrong(character.name, character.house),

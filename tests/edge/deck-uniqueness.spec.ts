...
test.describe('Deck uniqueness @edge', () => {
  ...
  test('E11: no duplicate hangman character names within a deck cycle', { tag: '@edge' }, async ({ page }) => {
  ...
  test('E12: no duplicate hangman spells within a deck cycle', { tag: '@edge' }, async ({ page }) => {
